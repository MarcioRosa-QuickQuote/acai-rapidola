          ...
          <div className="order-status-bar">
            ...
            <div className="order-status-step">
              <div style={{ height: 56, width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <img src="/t_vem_acai.png" style={{ width: '100%', height: '100%', objectFit: 'contain', opacity: currentStep >= 0 ? 1 : 0.6 }} />
              </div>
              ...
              <div style={{ height: 260 }}>
                <MapContainer
                  ...
                  <Marker position={[order.store_lat, order.store_lng]}
                    icon={L.divIcon({ html: '<img src="/t_vem_acai.png" style="width:46px;height:46px;object-fit:contain;filter:drop-shadow(0 2px 6px rgba(0,0,0,0.5))"/>', className: '', iconSize: [46, 46], iconAnchor: [23, 23] })} />
