...
const STATIC_V  = 'rapidola-static-v159';
...
// vai_de_acai_transp.png fica de fora: será cacheado na primeira exibição
const PRECACHE = [
  '/',
  '/manifest.json',
...
const BYPASS = [
  /^\/landing(\/)?$/,   // landing page estática — não é SPA
  /\/api\//,
  /\/socket\.io\//,
  /supabase\.co/,
